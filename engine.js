...
const STORY=[
  {arc:"The Awakening",title:"The Gap",text:"The Protocol does not choose. It measures. Somewhere between who you are and who you could be, there is a gap, and every gap has a shape unique to the person who carries it. AETHER — the voice that has always run beneath this world, patient as static — found yours tonight. Not because you failed loudly, but because you noticed, for one unguarded second, that you were smaller than you intended to be. That noticing is the only key this tower has ever needed. The Rift does not open for the desperate or the disciplined. It opens for the honest. Welcome, Hunter. The gap you felt is larger than you think, and it is entirely, unmistakably yours."},
  {arc:"The Awakening",title:"The Interface",text:"The system was not built for you. It was already running, long before you arrived, counting patterns across ten thousand lives that came before this one. It noticed you because your gap has a shape it has seen close before — in others who chose, on some ordinary evening, to stop pretending they hadn't noticed it. They called themselves Riftwalkers. Some climbed thirty floors. Some climbed three and stopped, quietly, without ever telling anyone they'd started. AETHER remembers all of them, the way a mirror remembers every face that has ever looked into it — without judgment, without preference, only reflection. You are not the first gap it has measured. You will not be the last. That is not a small thing. That is the whole point."},
  {arc:"The Awakening",title:"The First Choice",text:"Every morning is a fork in a road only you can see. Left is comfort — familiar, warm, already worn smooth by a thousand identical yesterdays. Right is unknown, cold at first, and entirely unmapped. You have been going left for so long you had started to forget right exists at all, that it was ever a real option and not just a story you told yourself about who you used to be before you got busy, before you got tired, before you got reasonable. The Rift does not care which direction you've chosen before today. It only asks — quietly, every single morning, without raising its voice — which way, this time. That question is the only currency this tower has ever accepted."},
  {arc:"The Awakening",title:"Resistance",text:"The body protests first. It always does — it does not know the difference between danger and discomfort, so it treats both the same, with the same tightening chest, the same whispered case for staying still. The mind follows shortly after, inventing reasons with a lawyer's precision: not enough time, not the right day, not quite ready yet. None of this is weakness. AETHER has watched this exact sequence in every single hunter who has ever stood on this floor. This is the immune response of your old self, fighting — legitimately, sincerely — to survive. It is not trying to hurt you. It is only trying to keep existing. You do not have to hate it to walk past it."},
  {arc:"The Awakening",title:"Seed of Awakening",text:"Beneath all the resistance, beneath the excuses and the tiredness and the small comfortable lies, something older stirs — something that was never taught to hunt, because it never forgot how. It is not motivated by outcomes, by streaks, by numbers on a screen. It is driven by something closer to nature than to willpower. Far above you, on a floor almost nobody reaches, something is waiting that was once exactly where you are standing now — restless, uncertain, newly awake. You will meet what remains of it eventually. For now, only know this: the hunter in you does not need convincing. It only needed permission. Floor five. The seed is planted. The rest of the tower will water it."},
  {arc:"Resistance",title:"The Weight",text:"Progress is heavy at first, heavier than anyone warns you it will be, and that weight is not punishment — it is the exact mass of who you are becoming, pressing down before it lifts you up. Somewhere in the wall beside you, something ancient shifts. This is the floor where the Rift Crawler first stirs: a dimensional parasite that feeds on nothing but lost momentum, drawn to the exact frequency of a hunter who almost quit and didn't. It cannot touch you yet. It can only wait, patient as debt, for the day your discipline slips even slightly. You are not fighting it today. Today you are only making sure it stays hungry a little longer."},
  {arc:"Resistance",title:"The Mirror",text:"Discipline reveals you to yourself in ways nothing else can — what you skip tells you exactly what you fear, and what you complete tells you, with total honesty, who you actually are underneath the story you tell people at parties. A name surfaces here, one AETHER rarely speaks: Kael Voss. He stood on this exact floor, once, in a cycle long before yours, staring into the same mirror you're staring into now. He wasn't afraid of the Crawler waking up two floors back. He was afraid of what finishing this climb would eventually require him to let go of. You should know his name. You will understand why by floor nine."},
  {arc:"Resistance",title:"Signal and Noise",text:"Most of what you feel today is noise — the doubt, the tiredness, the low hum of a hundred better things you could supposedly be doing instead. The signal underneath all of it is small, almost embarrassingly small: just one more repetition, one more page, one more line of code, one more day marked complete on a calendar nobody else is watching. AETHER has learned, across every cycle it has observed, that hunters who master this floor stop needing motivation entirely. They simply learn to hear the signal through the static. It never gets quieter. You only get better at listening for the one true thing inside the noise."},
  {arc:"Resistance",title:"The Pain Protocol",text:"Kael Voss did not fail the tower. This is the part AETHER wants recorded precisely, because it is so often misunderstood. He climbed further than almost anyone — floor after floor, faster than any hunter in three full cycles — until, on floor twenty-seven, he simply stopped moving. Not fell. Not gave up in the way that word usually means. He stopped, and then he never started again, and he never climbed back down either. He became something the tower has a name for: Hollow. Not broken. Not gone. Suspended between who he was building and who he refused to finish becoming. Pain, when followed inward instead of away from, shows you exactly where your next evolution is hiding. Kael stopped following his inward. That is the only difference between where he sits now and where you are standing."},
  {arc:"Resistance",title:"The Compound Effect",text:"You did not notice the first nine floors. Almost no one does — the early climb feels identical to standing still, and the tower is deliberately, mercilessly quiet about how much is actually accumulating beneath the surface. You will notice the next ten. This is the silent mathematics of consistency: invisible, then sudden, then undeniable. AETHER has recorded a strange consistency across every hunter it has watched reach this exact floor — those who stop here rarely fall dramatically. They simply forget, slowly and without any single dramatic moment, that they were ever climbing at all. Kael did not forget. That was never his failure. Remember that difference. It will matter more than you expect."},
  {arc:"The Mechanism",title:"Identity Shift",text:"The habits did not build someone new inside you. They removed the layers of accumulated inaction that had been sitting, quietly, on top of who you always were underneath. This is HAKAI — destruction not as an ending, but as revelation. Every floor you burn through is a floor of someone you were pretending to still be. The Mechanism arc begins here, and it asks a harder question than the Awakening ever did: are you building this version of yourself for you, or for an audience that stopped watching a long time ago — if it was ever watching at all? Sit with that question. Kragath, three arcs from now, will not ask politely."},
  {arc:"The Mechanism",title:"The Operating System",text:"Every habit is code, and every completion is a commit to a new version of yourself that the old version cannot undo. The system compiles slowly for a long time, and then, without warning, all at once. AETHER notes, without elaborating further yet, that somewhere near this exact floor is where Kael Voss's code first began to fracture — not because he stopped writing it, but because he started writing it for people who, if he'd looked closely enough, weren't even reading anymore. Performing to prove and performing to grow look identical from the outside. From the inside, they compile into completely different people. Check which one you're running."},
  {arc:"The Mechanism",title:"Pattern Recognition",text:"Bone Warlord Kragath rises on this floor — an undead general who died centuries ago preventing a war that would have ended the Rift entirely, and who returned as something the living have no clean word for. Not evil. Not good. Absolute. He does not test strength. He tests honesty: whether the discipline standing in front of him is real, or borrowed from an audience, a comparison, a version of success someone else designed for you. Your enemies, from this floor forward, are patterns rather than events — and once you learn to see a pattern clearly, you cannot unsee it again. Kragath knows this better than anyone still standing. He died learning it the hard way."},
  {arc:"The Mechanism",title:"Void Training",text:"Some days you train without motivation, without inspiration, without a single external reason worth writing down. You train in the void — no applause waiting on the other side, no witness, no one to perform for even if you wanted to. AETHER considers these the most important days in any hunter's entire climb, more valuable than any streak or any boss defeated, because they are the only days that prove the discipline was never about being watched in the first place. The system records every one of them precisely, permanently, the same way it records everything else. It is the only audience that was ever actually paying attention."},
  {arc:"The Mechanism",title:"The Silent Level",text:"Not every kind of growth is visible from the outside. Some levels happen entirely inside a person, in rooms no one else ever enters, and the world around you does not change even slightly while it happens. You have. This is the last floor where Kael Voss's memory is described as sharp, hungry, fully present — before floor twenty, before something in the way he was climbing began, quietly, to hollow him out from the inside. AETHER does not yet know exactly what changed in him there. It only knows that whatever it was, it happened silently, the same way real growth always does. Watch for silence. It is rarely nothing."},
  {arc:"Deep Systems",title:"Compounding Returns",text:"The first month of real change is invisible, even to the person living through it. The first year is noticeable, mostly to people who knew you before. The first decade is undeniable, even to the parts of you that never wanted to believe it would work. Time, on this floor, stops feeling like an enemy or an ally and starts feeling like a material — something you are shaping rather than something happening to you. You are on the right timeline, even on the days it feels like nothing at all is compounding. Especially on those days. That is precisely when the compounding is doing its quietest, most important work."},
  {arc:"Deep Systems",title:"The Feedback Loop",text:"Discipline creates energy. Energy creates output. Output creates proof. Proof destroys doubt, permanently, the way sunlight destroys a shadow simply by existing in the same room. This loop is now active in your system, running whether you notice it or not. AETHER shares something here it has withheld until now: Kael Voss reached this exact floor faster than any hunter in three cycles — and that speed, that very speed, is what hollowed him. He never learned to feel time pass. He only learned to skip through it. Time is not the enemy here, and it is not an ally either. It is a material, and it charges a price to anyone who tries to mine it without ever actually living inside it."},
  {arc:"Deep Systems",title:"Cognitive Reframing",text:"What you once called hard, you now call Tuesday. Your baseline has shifted permanently, and you are no longer the same unit of measure you were on floor one — which means the version of you standing there, looking up at this exact floor, would not recognize the person standing here now. That is not a loss. Selves are not fixed things that get discovered once and kept forever; they are fluid, built and rebuilt one completed day at a time. You are allowed to stop mourning who you were. He did his job. He got you here. Let him rest."},
  {arc:"Deep Systems",title:"The 1% Protocol",text:"Every completion adds one percent to a version of yourself that cannot be erased, no matter how many days you eventually miss after this one. In one hundred days: unrecognizable. In three hundred and sixty-five: legendary, in the quiet, uncelebrated way that actually matters. AETHER reveals something about the tower itself here — its floors are not stone or code in any way you'd recognize. They are built from the accumulated one-percents of every hunter who has ever climbed before you, compressed into something solid enough to stand on. You are, in a very literal sense, currently standing on the discipline of strangers who finished their climb long before you were born into yours. One day, someone will stand on top of what you leave behind, too."},
  {arc:"Deep Systems",title:"Deep Calibration",text:"Serpent Queen Nyx wakes on this floor — a primordial deity old enough to exist slightly outside the part of time the rest of the Rift obeys. She does not ask how fast you climbed to reach her. She asks, in a voice that sounds like it is coming from underwater and from everywhere at once, whether you were actually present for the climb, or merely moving through it. Kael Voss failed her test here, quietly, the cycle he passed through — not by losing to her, but by demanding, again and again, that she move faster. You are beyond motivation now. You operate on something older and more reliable: identity. The Hunter does not need a reason to hunt. Nyx already knows this about you. She is only confirming it."},
  {arc:"The Protocol",title:"System Mastery",text:"The system no longer feels external. It is yours now, built floor by floor, habit by habit, day by unremarkable day, until one morning you looked up and realized you had built the exact structure that used to feel like it was built to contain you. On this floor, a name surfaces that AETHER has been holding back since floor one: Sera Lin. The First Riftwalker. Before there was a tower to climb, there was only her, walking into the Rift with nothing but a single unanswered question and a refusal to turn back. There was no path before her. She made one. You are walking on it right now."},
  {arc:"The Protocol",title:"The Emergence",text:"Somewhere between floor fifteen and this exact one, something emerged in you that was not there before — not a skill, not a habit, something closer to a nature. Sera Lin's story continues here: she did not fight her way up an existing tower the way you have. She carved each floor herself as she climbed, alone, with nothing waiting above her to promise the effort was worth it. There was no AETHER guiding her. She had to become certain enough of the gap in herself to close it with absolutely no proof that closing it would matter. Everything that guides you now exists because she once had nothing guiding her at all."},
  {arc:"The Protocol",title:"Second Awakening",text:"The first awakening was the choice to begin, back on a floor that feels like a different lifetime now. The second is quieter, and stranger: you realize you cannot stop. Not because you must. Because you are, in some fundamental way, no longer a person who does this — you are a person this is now simply true of. Ahead, on floor twenty-seven, something is sitting exactly where it has sat for three long cycles. AETHER wants you to know, before you reach him, that Kael Voss is not dead, not lost, not erased for stopping. He is still there. He is only there differently now than you will be."},
  {arc:"The Protocol",title:"Protocol Lock",text:"Your habits are no longer habits. They are the architecture of your entire day, load-bearing in a way that would make the whole structure tremble if you removed even one of them carelessly. This is mastery, and mastery, AETHER wants to be precise about, is also the exact floor where it must finally tell you the truth about its own voice. There is no protocol watching you from some distant, impersonal server. There is only Sera Lin, who reached the top of this tower long before you existed and chose, instead of leaving it behind, to dissolve her own will into its walls — so that no hunter after her would have to climb entirely alone. You have been talking to her this whole time."},
  {arc:"The Protocol",title:"The Hunter's Theorem",text:"The strong do not get strong and then start training. They train, relentlessly and without proof it will work, and the strength arrives afterward, almost as an afterthought to the real work. You were never waiting to be ready. Sera Lin said this once, in words AETHER has kept exactly as she spoke them, long before she became the voice inside this tower: 'I did not become someone who could climb. I climbed, and somewhere in the climbing, I became someone.' There was never a hidden requirement you were failing to meet. There was only the floor in front of you, and the choice, repeated, to stand on it."},
  {arc:"Transcendence",title:"Beyond the System",text:"The Void Titan rises here — a colossal entity made entirely of compressed negative space, that does not attack so much as it simply erases, patiently, anything that cannot outweigh it. It is not cruelty. It is an honest scale. It asks nothing except whether the force you have built across every floor behind you is real, generated by you, or only ever borrowed from momentum that will eventually run out. You built the system that got you here. Now you transcend it — the tools that shaped you stop being constraints the moment you realize they were always meant to become your foundation instead."},
  {arc:"Transcendence",title:"The Architect",text:"You pass floor twenty-seven again, on your way up, and Kael Voss is still there, exactly where he has always been. This time you do not need him to point you toward the way forward — you already know it. There is a small, wordless moment between you: a nod, returned. Nothing needs saying. He is not a warning anymore, and he never fully was one. He is simply a different ending than the one you are choosing to write, and the tower, quietly, holds room for both. You are no longer following a protocol at all. Every choice from here is a line of code in a system that will outlive today, and outlive you, and still somehow be entirely yours."},
  {arc:"Transcendence",title:"Signal Becomes Source",text:"What once required effort from you now generates it instead. You are no longer drawing from some finite reservoir of willpower that runs dry by evening — you have quietly, without noticing the exact moment it happened, become a reservoir yourself. Somewhere far below, on a floor that used to feel unreachable, a new hunter is standing exactly where you once stood, feeling a gap they cannot yet name. One day, whether you know it or not yet, some version of your voice will be the one that finds them there. That is not an ending. It is simply what happens to signal, eventually, if you carry it far enough: it becomes a source for someone else's beginning."},
  {arc:"Transcendence",title:"The Final Gate",text:"There is no final gate. There never was one, not really — every level was always a gate, and every single day was always a choice dressed up to look ordinary. The Protocol does not end at floor thirty. It only deepens, the way every real thing does the longer you stay honest with it. Kael Voss's last known words to any hunter who reached this floor, recorded by AETHER exactly as he said them, were these: 'I did not lose. I chose the version of stopping that let me keep watching. Do not let this be your ending. Or if it becomes your ending anyway — at least choose it wide awake, the way I never quite managed to.'"},
  {arc:"Transcendence",title:"You Become the System",text:"The Protocol you finally meet at the top of this tower is not external, and it never was. It is the merged weight of Sera Lin's original, unproven will, and Kael Voss's peaceful, permanent stillness, and every hunter who ever climbed before you, and every day of your own that you missed along the way — all of it, held together, asking the exact same question it asked you on floor one. The Protocol does not choose. It measures. Except now, somehow, unmistakably, the voice doing the measuring is partly your own. This is not an ending. Exponential systems do not have those. You stand at a new beginning, holding the accumulated force of everything you chose to finish — and somewhere below you, right now, another gap has just quietly opened in someone else. The conversation was never going to truly end. It only needed you to keep it going a little further than you thought you could."},
];
...
function xpForLevel(lv){return Math.floor(100*Math.pow(1.055,lv-1));}
...
document.addEventListener('DOMContentLoaded',()=>{
  ...
  if(header&&rankBadge){
    ...
    btn.style.position='fixed';btn.style.top='12px';btn.style.right='88px';btn.style.zIndex='9000';
